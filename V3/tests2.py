...
from sandwich_calc_V3 import sandwich_pool
...
status, amount, profit, victim_output = sandwich_pool(pool_address, zeroForOne, amountSpecified, sqrtPriceLimitX96, w3)
print(amount, profit)
...
status, amount0, amount1 = sandwich_pool(pool_address, zeroForOne, amountSpecified, sqrtPriceLimitX96, w3)
