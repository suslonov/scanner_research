...
request_token2 = "cyb3rgam3r420_Gamer"
...
ast1 = parser.parse(source_code_filtered1, loc=False, strict=False)
...
completion = client.chat.completions.create(
  ...
  messages=[
    ...
    {"role": "user", "content": request_token1 + " token is " + source_code_filtered1},
    {"role": "user", "content": request_token2 + " token is " + source_code_filtered2},
    {"role": "user", "content": "please give the measure of likeness from 0 to 100"},
    {"role": "user", "content": "give report on differences as detailed as possible, put all to JSON fields"},
    {"role": "user", "content": 'fields for JSON shoud be: "tokenLikeness", "description", "majorDifferences", "nonStandardFeatures"'},
    # {"role": "user", "content": "give specific details related to fees"},
    # {"role": "user", "content": "describe which token can be a trap for the buyers"},
  ]
)
